...
<div class="page-header">
  ...
  <div class="page-header-actions">
    ...
    <button class="btn btn-outline btn-sm" onclick="openModal('acte-civil')" title="Afficher le formulaire actuellement chargé">
...
<script>
  document.addEventListener("DOMContentLoaded", () => {
    // 💡 CORRECTION 1 : Sécurisation Null-Safe du JSON via JSP Expression Language
    // Évite un crash de script (SyntaxError) si la table ou l'attribut est vide au premier chargement
    ...
    const acteTable = new DynamicTable({
      ...
      <%-- 💡 CORRECTION 2 : Changement de l'icône de Décès (Remplacement de 'ti-scooter' par 'ti-ribbon' ou 'ti-candle') --%>
      <i class="ti \${a.typeActeLabel === 'Naissance' ? 'ti-baby-carriage' : a.typeActeLabel === 'Mariage' ? 'ti-rings' : 'ti-candle'}" style="color:var(--text-muted);font-size:14px" aria-hidden="true"></i>
      \${a.typeActeLabel}
      </span>
      </td>
