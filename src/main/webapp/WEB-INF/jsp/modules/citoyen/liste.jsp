...
<%-- Inclusion du script générique Assurer par le layout --%>

<script>
  document.addEventListener("DOMContentLoaded", () => {
    // 1. Récupération directe et sécurisée du JSON Gson
    const citoyensData = ${citoyensJson};
    ...
    const citoyenTable = new DynamicTable({
      ...
      <a href="${pageContext.request.contextPath}/citoyen/detail?id=\${c.id}" class="btn btn-ghost btn-sm btn-icon" title="Voir">
